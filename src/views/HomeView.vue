<template>
  <main class="home-view">
    ...
    <p>This is your homepage where you can get an overview of your tasks, projects, and other features.</p>
    <div class="content">
      ...
      <p>Navigate through the sidebar to explore more!</p>
    </div>
  </main>
</template>
...
<style lang="scss">
@import '@/styles/scss/homeview.scss';
</style>
